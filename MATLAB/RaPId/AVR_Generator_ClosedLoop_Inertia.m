...
%Output data
rapidSettings.experimentData.pathToReferenceData = 'measuredDataO_whitenoise_Gen_speed.mat'; %Data file name
...
rapidSettings.experimentSettings.t_fitness_start = 3; %Start calculating fintess function after t_fintess_start
...
rapidSettings.experimentSettings.pathToSimulinkModel = 'gen_sim_model_speed.mdl'; %Simulink model file name
rapidSettings.experimentSettings.pathToFMUModel = 'Gen_AVR_system.fmu'; %FMU file name
rapidSettings.experimentSettings.modelName = 'gen_sim_model_speed'; %Simulink model name
rapidSettings.experimentSettings.blockName = 'gen_sim_model_speed/Gen_AVR_system'; %FMU name
...
rapidSettings.fmuOutputNames = {'gENROE.SPEED'};%{'EFD','gENROE.P','gENROE.Q'}; %Output variable names

%% ==========Running the computation==========

%Opening simulink model
open_system(rapidSettings.experimentSettings.pathToSimulinkModel); %Opening the simulink model
open_system(strcat(rapidSettings.experimentSettings.modelName,'/SPEED')); %Opening the scope in the model to observe estimation process
