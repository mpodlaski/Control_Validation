...
rapidSettings.experimentSettings.ts = 0.02; %Sampling time
...
rapidSettings.experimentSettings.p_0 = [0 1.0451   6    0.1302    0.9981  270.8140    0.1493    5.28 -4.41];

%                                         0.2, 0.001, 1.5, 1.1;
%                                         1, 2, 1.3, 0.5;
%                                         1.3, 3, 0.87, 0.45;
%                                         1.5, 3.1, 0.9, 0.6]; %Initial parameter guesses
rapidSettings.experimentSettings.p_min =  [0, 0,0,0,0,0,0,0,-10]; %Minimum values of parameters
rapidSettings.experimentSettings.p_max =  [1, 5,20,1,1,1000,1,10,0]; %Maximum values of parameters

i = 9;
rapidSettings.experimentSettings.p_0 = rapidSettings.experimentSettings.p_0(8:i);
rapidSettings.experimentSettings.p_min = rapidSettings.experimentSettings.p_min(8:i);
rapidSettings.experimentSettings.p_max = rapidSettings.experimentSettings.p_max(8:i);
...
rapidSettings.parameterNames = rapidSettings.parameterNames(8:i);
