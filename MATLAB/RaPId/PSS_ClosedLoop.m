...
rapidSettings.experimentSettings.maxIterations = 2000; %Maximum number of estimation iterations
...
rapidSettings.experimentSettings.pathToFMUModel = 'system.fmu'; %FMU file name
rapidSettings.experimentSettings.modelName = 'gen_sim_model'; %Simulink model name
rapidSettings.experimentSettings.blockName = 'gen_sim_model/system'; %FMU name
...
%                                         0.758 1 0.12 0.1 2...
%                                         0.47 0.07 0.47 0.07];
rapidSettings.experimentSettings.p_0 = [0 5 0 5 5 5 ...
                                        0.758 1 0.12 0.1 2 0.47...
                                        0.07 0.47 0.07];
%                                         0.2, 0.001, 1.5, 1.1;
%                                         1, 2, 1.3, 0.5;
%                                         1.3, 3, 0.87, 0.45;
%                                         1.5, 3.1, 0.9, 0.6]; %Initial parameter guesses
rapidSettings.experimentSettings.p_min =  [0 1 0 1 1 1 ...
                                        0.01 0 0.012 0.01 1 0.01...
                                        0.05 0.1 0.05
                                           ]; %Minimum values of parameters
rapidSettings.experimentSettings.p_max =  [0.01 10 0.01 10 10 10 ...
                                        1 3 0.2 0.2 3 0.75...
                                        0.1 1 0.1]; %Maximum values of parameters
...
rapidSettings.parameterNames = {'pSS2A.T_w1','pSS2A.T_w2','pSS2A.T_6','pSS2A.T_w3','pSS2A.T_w4','pSS2A.T_7','pSS2A.K_S2','pSS2A.K_S3','pSS2A.T_8','pSS2A.T_9','pSS2A.K_S1','pSS2A.T_1','pSS2A.T_2','pSS2A.T_3','pSS2A.T_4'};
